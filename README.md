...
038 - Exercício Python 038: Escreva um programa que leia dois números inteiros e compare-os. mostrando na tela uma mensagem: 
...
– 25 até 30: Sobrepeso
– 30 até 40: Obesidade I
– Acima de 40: Obesidade Mórbida

044 - um programa que calcule o valor a ser pago por um produto, considerando o seu preço normal e condição de pagamento:
...
105 - Exercício Python 105: Faça um programa que tenha uma função notas() que pode receber várias notas de alunos e vai retornar um dicionário com as seguintes informações:
...
114 - Crie um código em Python que teste se um site está acessível pelo computador usado.